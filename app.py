...
with tab_minerals:
    ...
    fig = px.bar(df_grouped, x="License Count", y="subnational1", color="Mineral", orientation="h",
                 title="⛏️ Mineral Licenses by Selected States and Minerals", barmode="stack")
...
with tab_conflict:
    ...
    with col1:
        ...
        fig_pie = px.pie(conflict_by_type, names="Event Type", values="Count", hole=0.4,
    ...
    with col2:
        ...
        fig_bar = px.bar(top_conflict_states, x='subnational1', y='Total_Conflict_Events',
                         color='Total_Conflict_Events', title="Top States by Conflict Events")
...
with tab_env:
    ...
    fig_carbon = px.line(carbon_yearly, x="Year", y="Emissions", markers=True,
...
st.markdown("""
<style>
div.block-container { padding-bottom: 1rem; padding-top: 1rem; }
